-- Ro-Ghoul Ultimate Script Hub v5.0 FINAL
-- Game: https://www.roblox.com/games/914010731/Ro-Ghoul
-- Made by Claude AI - With Skill Selection
...
Title.Text = "👻 Ro-Ghoul v5.0 | " .. SelectedFaction
...
local function CreateToggle(name, tab, callback)
    ...
    -- Check if default should be enabled (for skills)
    ...
    -- Initialize callback with default state
    callback(enabled)
end
...
CreateToggle("⬆️ Jump", "Combat", function(e) JumpPowerEnabled = e end)
...
CreateSlider("🦘 Jump Power", "Combat", 50, 300, 100, function(v) JumpPowerValue = v end)
...
print("✅ Ro-Ghoul Ultimate v5.0 loaded!")
print("👻 Faction: " .. SelectedFaction)
print("⚔️ Skills customizable in Skills tab!")
